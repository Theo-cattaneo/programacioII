...
class TatetiApp:
    def __init__(self, root):
        ...
        self.BUTTON_COLOR = '#4a235a'  # Morado oscuro para los botones
        self.BUTTON_HOVER_COLOR = '#7307A5'
        self.X_COLOR = '#9b59b6'  # Lila para la X
    ...
    def create_start_menu(self):
        ...
        rules_text = (
            "Cada jugador tiene 15 segundos\n"
    ...
    def create_game_board(self):
        ...
        # --- CAMBIO CLAVE: Se configura el frame para que se expanda ---
        board_frame.pack(fill=tk.BOTH, expand=True, pady=10, padx=10)

        # --- CAMBIO CLAVE: Se configuran filas y columnas para que tengan peso y se expandan ---
        for i in range(3):
        ...
        for i in range(3):
            for j in range(3):
                ...
                # --- CAMBIO CLAVE: 'sticky' hace que el botón llene toda su celda ---
    ...
    def update_status(self):
        ...
        if self.game_mode == 'pvp':
            player_name = "Jugador X (Lila)" if self.current_player == 'X' else "Jugador O (Rojo)"
        else: # bot mode
